...
const translations = {
  zh: {
    ...
    admin_editPost: '編輯文章',
    admin_logout: '登出',
    admin_title: '標題（只允許中文、英文、數字與空格）',
    admin_titleInvalid: '標題只能包含中文、英文、數字與空格',
  ...
  en: {
    ...
    admin_title: 'Title (Chinese, English letters, digits, and spaces only)',
    admin_titleInvalid: 'The title may only contain Chinese, English letters, digits, and spaces',
