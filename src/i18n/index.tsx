...
const translations = {
  zh: {
    ...
    admin_editPost: '編輯文章',
    admin_logout: '登出',
    admin_title: '標題（只允許中文與 ASCII 可見字元）',
    admin_titleInvalid: '標題只能包含中文與 ASCII 可見字元（英文、數字、符號與空格），且不可全為空白',
    admin_slugConflict: '此標題產生的網址已被其他文章使用，請換一個標題',
    admin_slug: '網址（由標題自動產生）',
    admin_content: '內容（Markdown）',
    admin_lang: '語言',
    admin_tags: '標籤（選填，以逗號分隔）',
    admin_excerpt: '預覽摘要（選填，顯示在文章列表卡片）',
    admin_published: '發布',
    admin_draft: '草稿',
    admin_status: '狀態',
    admin_save: '儲存',
    ...
    admin_upload: '上傳檔案',
    admin_uploading: '上傳中…',
    admin_uploadError: '上傳失敗：',
    admin_uploadTypeInvalid: '僅支援 jpg、jpeg、png、mp4、mov 檔案',
    admin_uploadBucketMissing:
      '儲存空間尚未建立：請到 Supabase Dashboard → Storage 建立名為 media 的 Public bucket，並在 Policies 允許 authenticated 使用者 INSERT（詳見 supabase/schema.sql 的說明）',
    admin_uploadHint: '上傳圖片／影片檔（jpg、jpeg、png、mp4、mov），並在游標處插入 ![](網址) 語法',
  ...
  en: {
    ...
    admin_title: 'Title (Chinese and visible ASCII characters only)',
    admin_titleInvalid:
      'The title may only contain Chinese and visible ASCII characters (letters, digits, symbols, and spaces), and cannot be all whitespace',
    admin_slugConflict: 'The URL generated from this title is already used by another post. Please choose a different title.',
    admin_slug: 'URL (auto-generated from the title)',
    ...
    admin_upload: 'Upload files',
    admin_uploading: 'Uploading…',
    admin_uploadError: 'Upload failed: ',
    admin_uploadTypeInvalid: 'Only jpg, jpeg, png, mp4, and mov files are supported',
    admin_uploadBucketMissing:
      'Storage bucket is missing: in the Supabase Dashboard → Storage, create a Public bucket named "media" and add a policy allowing authenticated users to INSERT (see the notes in supabase/schema.sql)',
    admin_uploadHint: 'Upload image / video files (jpg, jpeg, png, mp4, mov) and insert ![](url) syntax at the cursor',
